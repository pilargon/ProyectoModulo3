...
{
    public partial class NeveraAzureContext : DbContext
    {
        public NeveraAzureContext()
        {
        }

        public NeveraAzureContext(DbContextOptions<NeveraAzureContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<IngredienteReceta>(entity =>
            {
                ...
                entity.HasOne(d => d.Ingrediente)
                    .WithMany(p => p.IngredienteReceta)
